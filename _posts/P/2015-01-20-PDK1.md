...
description: ""
category: genes
tags: [magnaporthe oryzae, disease resistance, disease, blast, abiotic stress, biotic stress, Gene]
---
{% include JB/setup %}
...
## Key figures
![phenotype]({{ BASE_PATH }}/assets/images/PDK1.pheno.png)
![expression]({{ BASE_PATH }}/assets/images/PDK1.exp.png)
